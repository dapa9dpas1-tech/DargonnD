<?php
if (is_logged_in()) { header('Location: ' . (is_admin() ? '?page=admin' : '?page=home')); exit; }
?>
<section class="w-full py-space-3xl lg:py-space-4xl px-margin-mobile md:px-margin-desktop bg-surface-container-low min-h-screen flex items-center justify-center relative">
    ...
    <!-- Background Image or Gradient Overlay (Optional) -->
        ...
        <div class="lg:col-span-7 flex flex-col justify-between p-6 sm:p-10 lg:p-12 bg-surface">
            ...
            <div class="mt-4 mb-8">
                <div class="grid grid-cols-2 p-1 bg-surface-container rounded-lg border border-outline text-label-md font-semibold">
                    <a href="?page=login" class="py-2.5 rounded-md transition-all duration-150 flex items-center justify-center gap-2 bg-primary text-on-primary shadow-sm">
                        <span class="material-symbols-outlined text-base">login</span>
                        Masuk (Login)
                    </a>
                    <a href="?page=register" class="py-2.5 rounded-md transition-all duration-150 flex items-center justify-center gap-2 text-on-surface-variant hover:bg-surface-container-high hover:text-on-surface">
            ...
            <div class="relative min-h-[350px]">
                <div class="space-y-6">
                    <div class="mb-5">
                        <h3 class="text-headline-sm font-bold text-on-surface">Masuk ke Basecamp Explorer</h3>
                        <p class="text-body-sm text-on-surface-variant mt-1">Akses riwayat ekspedisi, order gear, dan tracking logistik.</p>
                    ...
                    <form method="POST" class="space-y-5">
                        ...
                        <div class="flex flex-col gap-space-xs">
                            <label class="text-label-sm font-semibold text-on-surface">Email Explorer / Call Sign</label>
                        ...
                        <div class="flex flex-col gap-space-xs">
                            <div class="flex items-center justify-between">
                                ...
                                <a href="#" class="text-label-sm text-primary hover:underline font-medium">Lupa Kata Sandi?</a>
                            </div>
                            <input type="password" name="password" class="w-full rounded-md border border-outline bg-surface px-3.5 py-2.5 focus:ring-2 focus:ring-primary focus:border-primary text-on-surface placeholder-outline transition" placeholder="••••••••••••" required>
                        </div>
